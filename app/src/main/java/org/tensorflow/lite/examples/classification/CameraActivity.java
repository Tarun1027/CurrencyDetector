    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        try {
          ...
          } else if (recognitionTextView.getText().toString().equalsIgnoreCase("50") && confi > 99.5) {
            mp.start();
          } else if (recognitionTextView.getText().toString().equalsIgnoreCase("200") && confi > 99.5) {
            mp1.start();
          }
        }catch (Exception e){
          e.printStackTrace();
